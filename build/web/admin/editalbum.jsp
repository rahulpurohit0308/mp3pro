...
%>
        <div class="container">
                <div class="form-group">
                    <label for="example-datetime-local-input" class="col-form-label">Edit Album</label>
                    <input class="form-control" type="Text" name="album" value="<%=rs.getString("album_name")%>" id="albumm">
                    <label for="example-datetime-local-input" class="col-form-label">Edit Description</label>
                    <textarea class="form-control" type="Text" name="des" id="des"></textarea>
                    <input type="submit" class="btn btn-primary updatee mt-3" style="margin: 6px" value="Update">
                </div>
        </div>
<%
                    }
